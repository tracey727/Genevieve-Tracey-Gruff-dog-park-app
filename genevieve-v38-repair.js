/* GENEVIEVE Dog Parks V38 — exact-logo lock and header-first landing guard. */
(() => {
  'use strict';
  const VERSION = '20260731-ga-left-only';
  ...
  const TREE_FALLBACK = './assets/genevieve-roots.png';
